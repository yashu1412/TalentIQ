      ...
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <h1 style={{ fontFamily: "Syne, sans-serif", fontSize: 30, fontWeight: 800, color: "#FFFFFF" }}>
              Career Overview
            </h1>
          </div>
            ...
            <div style={{ height: 180 }}>
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={activityData}>
                  ...
                  <XAxis dataKey="day" stroke="#262626" axisLine={false} tickLine={false} fontSize={11} tick={{ fill: "#71717a" }} />
                  <YAxis hide />
            ...
            <div style={{ height: 180 }}>
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={funnelData} layout="vertical">
                  ...
                  <YAxis dataKey="name" type="category" stroke="#262626" axisLine={false} tickLine={false} width={80} fontSize={10} tick={{ fill: "#71717a" }} />
        ...
        <div className="grid lg:grid-cols-3 gap-4">
          ...
          <div className="lg:col-span-2 glass-card p-5">
            ...
            <div className="space-y-3">
              {RECENT_ACTIVITY.map((item, i) => (
                <div key={i} className="flex items-center gap-3 p-3 rounded-xl" style={{ background: "rgba(10,10,10,0.5)" }}>
                  <div className="p-2 rounded-lg flex-shrink-0" style={{ background: `${item.color}18`, color: item.color }}>
                    {item.icon}
                  </div>
                  <p className="flex-1 text-sm" style={{ color: "#A1A1AA" }}>{item.text}</p>
                  <span className="text-xs flex-shrink-0" style={{ color: "#52525b" }}>{item.time}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="glass-card p-5 flex flex-col" style={{ borderColor: "rgba(139,92,246,0.3)" }}>
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center py-4">
              ...
              <p style={{ fontFamily: "Syne, sans-serif", fontWeight: 700, color: "#FFFFFF", marginBottom: 4 }}>No scheduled sessions</p>
              <p className="text-xs mb-6" style={{ color: "#71717a" }}>Start a mock interview to practice before your next round.</p>
              <Link href="/mock-interview" className="glow-btn text-sm w-full justify-center"
        ...
        <div className="grid md:grid-cols-4 gap-4">
          {[
            ...
            <Link key={i} href={action.href} className="glass-card glass-card-hover p-5 block">
              ...
              <h3 style={{ fontFamily: "Syne, sans-serif", fontWeight: 700, color: "#FFFFFF", marginBottom: 4, fontSize: 15 }}>{action.title}</h3>
              <p style={{ fontSize: 12, color: "#71717a" }}>{action.desc}</p>
            </Link>
          ))}
        </div>
