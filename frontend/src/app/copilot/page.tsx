...
const INTENT_MAP: Record<string, { label: string; color: string }> = {
  ...
  naukri_summary:  { label: "Naukri.com",      color: "#4B6BFB" },
  ycombinator_summary:{ label: "Y Combinator", color: "#FF6600" },
...
const QUICK_PROMPTS = [
  ...
  "Write an ATS-friendly Naukri profile headline & summary",
  "Draft a Y Combinator Startup bio/intro from my resume",
