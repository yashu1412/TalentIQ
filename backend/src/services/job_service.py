...
class JobAnalysis(BaseModel):
    ...
    required_skills: List[str] = Field(description="Must-have skills required for the role")
    preferred_skills: List[str] = Field(description="Nice-to-have skills for the role")
    experience_level: str = Field(description="Years of experience or seniority level required")
    summary: str = Field(description="Brief overview of the role and responsibilities")
...
class JobService:
    ...
    def calculate_ats_match(self, resume_skills: List[str], job_skills: List[str]) -> Dict[str, Any]:
